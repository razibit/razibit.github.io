...
export default function Hero() {
  return (
    <section
      id="hero"
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-gray-50 to-surface px-6"
    >
      <div className="max-w-3xl text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 border border-gray-300 hover:border-accent text-gray-700 hover:text-accent px-6 py-3 rounded-lg font-medium transition-colors"
          >
            Download CV
