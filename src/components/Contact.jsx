        ...
        <div className="flex flex-wrap justify-center gap-4">
          {links.map((l) => (
            <a
              ...
              className="inline-flex items-center gap-2 bg-white border border-gray-200 hover:border-accent hover:text-accent text-gray-600 px-5 py-3 rounded-xl font-medium text-sm transition-colors shadow-sm"
            >
              {l.icon}
              {l.label}
            </a>
